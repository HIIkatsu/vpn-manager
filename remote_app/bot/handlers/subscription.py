...
async def subscription_pay_callback(callback: CallbackQuery, user_service: UserService, session: AsyncSession) -> None:
    ...
    if settings.ANYPAY_PROJECT_ID and settings.ANYPAY_SECRET_KEY:
        ...
        ap_params = {"merchant_id": settings.ANYPAY_PROJECT_ID, "pay_id": anypay_pay_id, "amount": amount_str, "currency": "RUB", "desc": "VPN", "success_url": "https://t.me/AnKoVPN_bot", "fail_url": "https://t.me/AnKoVPN_bot", "sign": hashlib.sha256(f"{settings.ANYPAY_PROJECT_ID}:{anypay_pay_id}:{amount_str}:RUB:VPN:https://t.me/AnKoVPN_bot:https://t.me/AnKoVPN_bot:{settings.ANYPAY_SECRET_KEY}".encode()).hexdigest()}
