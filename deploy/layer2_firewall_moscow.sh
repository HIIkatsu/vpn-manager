#!/usr/bin/env bash
# =============================================================================
# Layer 2: Firewall — Moscow (Edge Node)
...
table inet vpn_firewall {
    ...
    chain input {
        ...
        # --- RU-specific Xray ports (clients connect directly) ---
    ...
    chain forward {
        ...
        # Edge node does not forward traffic
    }
...
# Verify port 8090 is only accessible from Helsinki
echo "=== Port 8090 access control ==="
nft list ruleset | grep 8090
echo ""

echo "========================================="
echo "  Layer 2 Moscow COMPLETE"
echo "  Default DROP policy active"
echo "  Allowed: 22(ssh), 443/10444/10445(vpn)"
echo "  8090 restricted to Helsinki only"
echo "========================================="
